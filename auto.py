...
#'122-124-125-301-126-127-128-129'

#'101','121','205','206','207','210','216', '508', '509','702', '853'
domain_cols_dict = {
    'alimama':['age_level','pid','cms_group_id'],#,'cms_segid'],
    #'alicpp':['122','124','125','301','126','127','128','129'],
'alicpp':['122-301','124-301','125-301','126-301','127-301','128-301','129-301'],
    ...
    'avazu':[ 'banner_pos', 'C18', 'site_id', 'site_domain','C1',
       'site_category', 'app_id', 'app_domain', 'app_category', 'device_id',
       'device_ip', 'device_model', 'device_type', 'device_conn_type', 'C14',
       'C15', 'C16', 'C17', 'C19', 'C20', 'C21']
}
domain_cols_dict = {'alimama':['pid'],
                    'alicpp':['301'],
                    'ijcai':['context_id'],
                    'alicpp_filtered':['301'],
                    'avazu':['banner_pos']}
...
flag_list = ['norelu']
flag_list = ['metatransv2','metatransv1']
flag_list = ['metatransv1']
#flag_list=['mex']
flag_list = ['metatransv1-qkvdiffnorm','metatransv2-qkvdiffnorm']
flag_list = ['mex-metatransfm-nofm','mex-nofm']
flag_list = ['mex-metatrans-metanorm']#,'mex-metatrans']
#flag_list = ['mex-metatrans']
#flag_list = ['mex']
#flag_list = ['metatransv1-samemeta']
flag_list = ['metatransv1']
#flag_list = ['mex-onlyemb','mex-noencrelu']
#flag_list = ['mex-bilinear','mex-noembinit']
flag_list = ['mex','mex-pos','mex-diffqkenc']
flag_list = ['mex-splitenc-splitemb','mex-splitenc']#,'mex-splitenc-splitemb']
#flag_list = ['mex-splitenc-dedim10','mex-splitenc-splitemb-dedim10']
flag_list=['mex-diffqkenc','mex']
flag_list = ['mex','mex-diffqkenc']
flag_list = ['metatransv1-samemeta']
flag_list = ['mex-noattndrop-nodrop','mex-noattndrop']
#flag_list=['mex-diffqkenc']
seed_list = [1024,1025,1026,1027,1028,1029,1030,1031]#,1026,1027]#,1026]#,1028]#[1025,1027]
#seed_list = [1027,1028,1029,1030,1031]
#seed_list = [1020,1024]#,1021,1022,1023]#,1030,1031]
#seed_list = [1000,1001,1002,1003,1004]#,1005,1010,1015,1025]
#seed_list = [1027,1028,1029,1030]
seed_list=[1000,1001]
seed_list=[1002,1003]
seed_list=[1004,1005]
    ...
    for domain_col in domain_cols_dict[data_name]:
        for parameters in product(*combines):
            ...
            if data_name=='avazu':
                embedding_dim=16
                pass
            elif data_name=='alicpp' and 'Trans' in model_name:
                learning_rate=0.005 if learning_rate not in [0.005, 0.002] else learning_rate
            #if data_name=='alimama':
            else:
                learning_rate=0.001

            cmd = f'python main.py --data_name {data_name} --model_name {model_name} --seed {seed} --embedding_dim {embedding_dim} --learning_rate {learning_rate}'
            ...
            elif 'Starv3_Trans' in model_name or 'Meta_Trans' in model_name or 'Gate_Trans' in model_name:
