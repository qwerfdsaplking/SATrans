...
if os.path.exists('/home/featurize/data/2018-IJCAI-data/origion_concat.csv'):
    ...
    train = pd.read_csv('/home/featurize/data/2018-IJCAI-data/round2_train.txt', sep=' ')
    print('loaded')
    testa = pd.read_csv('/home/featurize/data/2018-IJCAI-data/round2_ijcai_18_test_a_20180425.txt', sep=' ')
    testb = pd.read_csv('/home/featurize/data/2018-IJCAI-data/round2_ijcai_18_test_b_20180510.txt', sep=' ')
    testa['is_trade'] = -1
    testb['is_trade'] = -2
